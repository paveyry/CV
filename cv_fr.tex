...
\familyname{VEYRY}
\title{Étudiant en ingénierie informatique à la recherche d'un stage de développeur entre Septembre et Décembre 2015}             
...
\section{Compétences techniques}
	\subsection{Langages de programmation}
        ...
        \cvcomputer{Expérimenté}{JAVA, C\#, OCaml, HTML, CSS}{Frameworks}{Swing, .NET}
        \cvcomputer{Débutant}{Python, Swift, Go}{}{}
	\subsection{Divers}
        \cvitem{Systèmes}{GNU/Linux, Mac OS X, Windows, BSD}{}{}{}{}
        \cvitem{Logiciels}{Blender 3D, Adobe Photoshop, Gimp, Steinberg Cubase}{}{}{}{}
